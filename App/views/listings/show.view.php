    ...
    <div class="rounded-lg shadow-md bg-white p-3">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-4 ml-4">
                <a href="/listing/edit/<?= $listings['id'] ?>" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded">Edit</a>
                <!-- Delete Form -->
                <form method="POST">
        ...
        <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4">
                <li class="mb-2"><strong>Salary:</strong> <?= formatSalary($listings['salary']) ?></li>
                <li class="mb-2">
                    <strong>Location:</strong> <?= $listings['city'] ?>, <?= $listings['country'] ?>
                    <span
